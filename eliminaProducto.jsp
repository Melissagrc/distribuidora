        ...
        <header class="header"></header>
         ...
         <%! Connection con;
          ...
          <%
              ...
              Matcher matcher=pattern.matcher(Id_producto);
          ...
          <%
            if(valido==1){
              ...
              Elimina = "DELETE FROM cliente where id_cliente="+Id_producto+"";
          ...
          <br><br><br><br><br><br><br><br><br><br><br>
            <h2 align="center"><br>Producto eliminado exitosamente</h2>
